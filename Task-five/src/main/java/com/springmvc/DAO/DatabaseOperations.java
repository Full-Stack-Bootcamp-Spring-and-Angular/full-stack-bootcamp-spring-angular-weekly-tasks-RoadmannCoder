...
public class DatabaseOperations {
    ...
    private void initDatabase() throws SQLException {
        ...
        statement.executeUpdate("CREATE DATABASE IF NOT EXISTS CONTACTS");
        statement.executeUpdate("USE CONTACTS");
        System.out.println(String.format("Database Created Successfully"));
        statement.executeUpdate("CREATE TABLE IF NOT EXISTS user (id INTEGER, firstName VARCHAR(255), lastName VARCHAR(255), email VARCHAR(255), dob DATE, city VARCHAR(255), PRIMARY KEY (id))");
        statement.close();
