...
public class DatabaseOperations {
    ...
    private void initDatabase() throws SQLException {
        ...
        statement.executeUpdate("CREATE DATABASE IF NOT EXISTS EMPLOYEE");
        statement.executeUpdate("USE EMPLOYEE");
        System.out.println(String.format("Database Created Successfully"));
        statement.executeUpdate("CREATE TABLE IF NOT EXISTS user (id INTEGER, username VARCHAR(255), email VARCHAR(255), PRIMARY KEY (id))");
        statement.close();
